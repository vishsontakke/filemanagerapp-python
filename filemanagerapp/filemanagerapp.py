...
delete_btn = Button(root, text="Delete File",command=delete_file, bg='red',width=15,font=('bold',14))
...
exit_btn = Button(root, text="Exit", command=root.destroy,bg='yellow', width=12,font=('bold',16))
